    ...
    <body>
        <div class="row">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(6*(24*60*60)))."\">".date("Y-m-d",time()-(6*(24*60*60)))."</a></li>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(5*(24*60*60)))."\">".date("Y-m-d",time()-(5*(24*60*60)))."</a></li>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(4*(24*60*60)))."\">".date("Y-m-d",time()-(4*(24*60*60)))."</a></li>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(3*(24*60*60)))."\">".date("Y-m-d",time()-(3*(24*60*60)))."</a></li>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(2*(24*60*60)))."\">".date("Y-m-d",time()-(2*(24*60*60)))."</a></li>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d",time()-(1*(24*60*60)))."\">".date("Y-m-d",time()-(24*60*60))."</a>";
                echo "<li><a href=\"loop.php?date=".date("Y-m-d")."\">".date("Y-m-d")."</a>";
                echo "</ol>";
                ...
                $query_log = mysqli_query($link_to_mysql, "SELECT * FROM SystemEvents WHERE ReceivedAt BETWEEN "
                        ...
                        . "Message LIKE '%oop%' ORDER BY ID DESC ") or die();
                echo "<h5>";
